    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="px-6 mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                                                       
                            <div class="flex items-center">
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-8 h-8 text-gray-500"><path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://github.com/claudiorigo/awsapi" class="underline text-gray-900 dark:text-white">Grupo de Stock:</a></div>
                            </div>
                                ...
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <ul>
                                        <li class="flex">                                            
                                            ...
                                            <span class="ml-2">Cristian Gutierrez</span>
                                        </li>
                                        <li class="flex">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="ml-4 -mt-px w-5 h-5 text-gray-400">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                                            </svg>
                                            <span class="ml-2">Ayrton Vegara</span>
                                        </li>
                                        <li class="flex">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="ml-4 -mt-px w-5 h-5 text-gray-400">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                                            </svg>
                                            <span class="ml-2">Mayron Guevara</span>
                                        </li>
                                        <li class="flex">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="ml-4 -mt-px w-5 h-5 text-gray-400">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path>
                                            </svg>
                                            <span class="ml-2">Claudio Rigollet</span>
                                        </li>
                                    </ul>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://claudiorigollet.cl/api/documentation" class="underline text-gray-900 dark:text-white">Documentación Swagger</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Para este proyecto aún esta al 50% con un dashboard en el cual se podra acceder a el crud de todas las tablas. por el momento al registrar y login podras acceder al menú <a href="https://claudiorigollet.cl/register" class="underline">Dashboard</a>
                                </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs/8.x" class="underline text-gray-900 dark:text-white">Laravel Documentation</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Endpoints Creados</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Para acceder a los crud de los enponts ya creados, creamos un accesos rapidos
                                    <a href="https://claudiorigollet.cl/api/products" class="underline">Productos</a>, 
                                    <a href="https://claudiorigollet.cl/api/categories" class="underline">Categorías</a>, 
                                    <a href="https://claudiorigollet.cl/api/subcategories" class="underline">Subcategorías</a>,
                                    <a href="https://claudiorigollet.cl/api/sales" class="underline">Ventas</a>,
                                    <a href="https://claudiorigollet.cl/api/users" class="underline">Usuarios</a>,
                                    <a href="https://claudiorigollet.cl/api/tickets" class="underline">Boletas</a>,
                                    and <a href="https://claudiorigollet.cl/api/bills" class="underline">Facturas</a> 
                                    para ellos existe ayuda en la documentación  <a href="https://claudiorigollet.cl/api/documentation" class="underline">Swagger</a>, 
                                    y en el proyecto total por <a href="https://github.com/claudiorigo/awsapi" class="underline">Github</a>
                                </div>
                            </div>
                        </div>
                    </div>
